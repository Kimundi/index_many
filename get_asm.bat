...
cargo asm codegen_test::option_simple() --no-color > 0_option_simple.asm
...
cargo asm codegen_test::option() --no-color > 0_option.asm
cargo asm codegen_test::option_unwrap() --no-color > 0_option_unwrap.asm
cargo asm codegen_test::result() --no-color > 0_result.asm
cargo asm codegen_test::result_kind() --no-color > 0_result_kind.asm
cargo asm codegen_test::result_option() --no-color > 0_result_option.asm
